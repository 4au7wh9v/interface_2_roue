...
void setup_scr_telephone(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->telephone_btnm_1, 100, 343);
    lv_obj_set_size(ui->telephone_btnm_1, 501, 508);

    //Write style for telephone_btnm_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->telephone_btnm_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->telephone_btnm_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->telephone_btnm_1, lv_color_hex(0xfafafa), LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->telephone_btnm_1, &lv_font_Alatsi_Regular_24, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->telephone_btnm_1, 255, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->telephone_btnm_1, 27, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->telephone_btnm_1, 255, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->telephone_btnm_1, lv_color_hex(0x91b5fe), LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->telephone_btnm_1, LV_GRAD_DIR_HOR, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->telephone_btnm_1, lv_color_hex(0x0c5681), LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui->telephone_btnm_1, 0, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui->telephone_btnm_1, 255, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->telephone_btnm_1, 1, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(ui->telephone_btnm_1, lv_color_hex(0x090a0a), LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui->telephone_btnm_1, 255, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui->telephone_btnm_1, 1, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_ofs_x(ui->telephone_btnm_1, 0, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_ofs_y(ui->telephone_btnm_1, 2, LV_PART_ITEMS|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->telephone_btn_1_label, "" LV_SYMBOL_HOME "");
    ...
    lv_obj_set_pos(ui->telephone_btn_1, 316, 9);
    lv_obj_set_size(ui->telephone_btn_1, 100, 117);

    //Write style for telephone_btn_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->telephone_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->telephone_btn_1, &lv_font_montserratMedium_26, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_imgbtn_set_src(ui->telephone_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, &_phone_card_alpha_100x64, NULL);
    lv_imgbtn_set_src(ui->telephone_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, &_phone_card_alpha_100x64, NULL);
    lv_imgbtn_set_src(ui->telephone_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_end_call_alpha_100x64, NULL);
    lv_imgbtn_set_src(ui->telephone_imgbtn_1, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_end_call_alpha_100x64, NULL);
    ...
    lv_obj_set_pos(ui->telephone_imgbtn_1, 306, 905);
    lv_obj_set_size(ui->telephone_imgbtn_1, 100, 64);
    ...
    lv_obj_set_pos(ui->telephone_btn_del, 589, 222);
