...
typedef struct
{
	...
	lv_obj_t *record;
	bool record_del;
	lv_obj_t *record_label_ODO_num;
	lv_obj_t *record_label_power_num;
	lv_obj_t *record_chart_1;
	lv_chart_series_t *record_chart_1_0;
...
LV_IMG_DECLARE(_dis__alpha_57x38);
LV_IMG_DECLARE(_ra_alpha_100x100);
LV_IMG_DECLARE(_telephone_alpha_100x100);
LV_IMG_DECLARE(_direction_alpha_96x97);
LV_IMG_DECLARE(_direction_alpha_94x102);
LV_IMG_DECLARE(_stats__alpha_100x100);

LV_IMG_DECLARE(_menu_radio_450x381);

LV_IMG_DECLARE(_play_391x391);
LV_IMG_DECLARE(_phone_card_alpha_100x64);
LV_IMG_DECLARE(_phone_card_alpha_100x64);
LV_IMG_DECLARE(_end_call_alpha_100x64);
LV_IMG_DECLARE(_end_call_alpha_100x64);
LV_IMG_DECLARE(_delete_alpha_100x100);

LV_FONT_DECLARE(lv_font_montserratMedium_12)
LV_FONT_DECLARE(lv_font_montserratMedium_18)
LV_FONT_DECLARE(lv_font_Antonio_Regular_123)
