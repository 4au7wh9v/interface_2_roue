...
void setup_scr_radio(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->radio_slider_1, 156, 194);
    lv_obj_set_size(ui->radio_slider_1, 450, 381);
    ...
    lv_obj_set_style_bg_img_src(ui->radio_slider_1, &_menu_radio_450x381, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_src(ui->radio_slider_1, &_play_391x391, LV_PART_KNOB|LV_STATE_DEFAULT);
    ...
    lv_span_set_text(ui->radio_spangroup_1_span, "105");
    ...
    lv_style_set_text_color(&ui->radio_spangroup_1_span->style, lv_color_hex(0xffffff));
    lv_style_set_text_decor(&ui->radio_spangroup_1_span->style, LV_TEXT_DECOR_NONE);
    lv_style_set_text_font(&ui->radio_spangroup_1_span->style, &lv_font_montserratMedium_34);
    lv_obj_set_pos(ui->radio_spangroup_1, 277, 62);
    lv_obj_set_size(ui->radio_spangroup_1, 296, 100);
    ...
    lv_label_set_text(ui->radio_btn_1_label, "" LV_SYMBOL_HOME "\n");
    ...
    lv_obj_set_pos(ui->radio_btn_1, 332, 634);
    ...
    lv_obj_set_style_text_font(ui->radio_btn_1, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->radio_radio_label, "");
    lv_label_set_long_mode(ui->radio_radio_label, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->radio_radio_label, 204, 571);
    lv_obj_set_size(ui->radio_radio_label, 316, 32);
    ...
    lv_obj_set_style_text_font(ui->radio_radio_label, &lv_font_montserratMedium_37, LV_PART_MAIN|LV_STATE_DEFAULT);
