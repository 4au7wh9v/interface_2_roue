...
static void home_event_handler (lv_event_t *e)
{
    ...
    {
        task_meter = lv_timer_create(speed_meter_timer_cb, 300, &guider_ui);
...
static void home_img_3_event_handler (lv_event_t *e)
{
    lv_event_code_t code = lv_event_get_code(e);
    switch (code) {
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.telephone, guider_ui.telephone_del, &guider_ui.home_del, setup_scr_telephone, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    default:
        break;
...
static void home_img_4_event_handler (lv_event_t *e)
{
    lv_event_code_t code = lv_event_get_code(e);
    switch (code) {
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.record, guider_ui.record_del, &guider_ui.home_del, setup_scr_record, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, false);
        break;
    }
    default:
        break;
...
void events_init_home (lv_ui *ui)
{
    ...
    lv_obj_add_event_cb(ui->home_img_3, home_img_3_event_handler, LV_EVENT_ALL, ui);
    lv_obj_add_event_cb(ui->home_img_4, home_img_4_event_handler, LV_EVENT_ALL, ui);
}
...
static void radio_slider_1_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_VALUE_CHANGED:
    {
        ...
        //}
        char textbuffer[16];
        lv_snprintf(textbuffer, sizeof(textbuffer), "%"LV_PRId32, (int)radio_value);
...
static void record_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_SCREEN_LOADED:
    {
        task_chart = lv_timer_create(record_chart_timer_cb, 100, guider_ui.record_chart_1);
        break;
    }
    case LV_EVENT_SCREEN_UNLOADED:
    {
...
static void record_btn_1_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.home, guider_ui.home_del, &guider_ui.record_del, setup_scr_home, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    default:
        break;
